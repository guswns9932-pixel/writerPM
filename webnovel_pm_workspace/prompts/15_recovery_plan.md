...
critical issue 발생 시 작업을 중단하고 안전한 복구 절차를 작성한다.
...
- halt_reason_code:
- 문제 요약:
- 수정 범위: TEXT_ONLY / SCENE_REWRITE / EPISODE_OUTLINE_REWRITE / CONTINUITY_REPAIR / BIBLE_CHANGE_REQUIRED
- 영향 파일:
- 보존 파일:
- 사용자 승인 필요 여부:
- 재개 가능한 최소 작업:
