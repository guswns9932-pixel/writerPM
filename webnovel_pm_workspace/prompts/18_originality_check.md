...
기획 또는 원고가 기존 작품 고유 설정, 용어, 대표 장면, 특정 작가 문체를 모방하지 않는지 점검한다.

## 입력 파일

- 검수 대상 기획 또는 원고
- `ORIGINALITY_HARNESS.md`
- `story_bible.json`
- `style_guide.json`
...
- `revision_note.md 또는 recovery_plan.md 필요 시`
...
| 점검 항목 | 상태 | 위험 설명 | 대체 제안 | final 저장 가능 여부 |
|---|---|---|---|---|
