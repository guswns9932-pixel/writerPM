...
작성된 개요 또는 원고가 canon, 능력 규칙, 파워 진행, 시간선, 인물 성격과 충돌하지 않는지 점검한다.
...
- `episode_XXX_continuity_review.md`
- `episode_XXX_status.md`
- `recovery_plan.md 또는 canon_change_request.md 필요 시`
...
| 항목 | 상태 | 근거 파일 | 문제 위치 | 조치 | final 저장 가능 여부 |
|---|---|---|---|---|---|
