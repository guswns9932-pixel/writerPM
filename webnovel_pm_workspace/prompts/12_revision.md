...
문체 수정이 필요한 경우 STYLE_HARNESS.md의 **13번 원고 수정 순서**를 따름:
...
5. **전투 장면에 목표/압박/대가 추가** - 나열 → 갈등
6. **대사 전후 흐름 보강** - 고립 대사 제거
7. **최종 원고에서 작업용 제목과 메타 설명 제거**
8. **리듬 검사** (QUALITY_HARNESS 문장 리듬 검사 항목 전수 점검)
