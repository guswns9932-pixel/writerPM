...
작업 전후 검수 기준을 담은 문서형 harness를 보관합니다. workflow, memory, continuity, quality, originality, feedback, recovery, versioning, cast, longform, rights, platform, content risk, human contribution, pattern repetition 기준과 보조 체크리스트가 여기에 속합니다.
