...
3. Harness 문서: workflow, memory, continuity, quality, originality, feedback, recovery, versioning, cast, longform, rights, platform, content risk, human contribution, pattern repetition
...
- `initial_3_episode_hook_plan.md`
